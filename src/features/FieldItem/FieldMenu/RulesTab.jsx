  ...
  return (
    <Box>
        ...
        <CardItemTabPanel value={0}>
          This field will be prefilled with data you put. You can fill out the field or put variable inside, just make sure it will not be empty.
        </CardItemTabPanel>
